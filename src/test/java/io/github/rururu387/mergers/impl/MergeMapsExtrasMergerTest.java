...
public class MergeMapsExtrasMergerTest extends MergerTestBase {
    public MergeMapsExtrasMergerTest() {
        super(new MergeMapsExtrasMerger());
    }
    ...
    @Test
    void WHEN_two_files_with_same_keys_but_different_subkeys_merged_THEN_result_contains_overriding_subkeys_only() {
        var overriddenYaml = """
                key:
                  subKey1: subValue1
                """;
